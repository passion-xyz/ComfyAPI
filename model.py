...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            required_input = [{'name': 'workflow', 'shape': [1], 'data': ['txt_2_img'], 'datatype': 'BYTES'}, {'name': 'positive_token', 'shape': [1], 'data': ['There is a fine house in the forest'], 'datatype': 'BYTES'}, {'name': 'negative_token', 'shape': [1], 'data': ['There is a fine house in the forest'], 'datatype': 'BYTES'}]
            inputs = {}
